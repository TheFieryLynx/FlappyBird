    ...
    def __init__(self):
        ...
        for i in range(2):
            self.barriers.append(
                pygame.image.load(
                    f'assets/barriers/barrier-{i}.png').convert_alpha(),
            )
...
class Score():
    def __init__(self):
        ...
        self.lil_nums = [pygame.image.load(
            f'assets/numbers/{i}-little.png') for i in range(10)]
        self.big_nums = [pygame.image.load(
            f'assets/numbers/{i}-big.png') for i in range(10)]
        self.score = 0
        self.images = [self.lil_nums[0]]
        self.rect = []
        self.rect.append(settings.WINDOW_WIDTH -
                         self.offset - self.images[0].get_width())
        self.rect.append(10)
